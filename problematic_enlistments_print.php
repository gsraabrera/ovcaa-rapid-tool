...
require_once("include/problematic_enlistments_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "problematic_enlistments" );
