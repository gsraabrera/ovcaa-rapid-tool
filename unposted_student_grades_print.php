...
require_once("include/unposted_student_grades_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "unposted_student_grades" );
