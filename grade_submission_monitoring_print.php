...
require_once("include/grade_submission_monitoring_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "grade_submission_monitoring" );
