...
$tdataenrollment_count_by_unit_and_batch[".pagesByType"] = my_json_decode( "{\"export\":[\"export\"],\"list\":[\"list\"],\"print\":[\"print\"],\"search\":[\"search\"]}" );
$tdataenrollment_count_by_unit_and_batch[".originalPagesByType"] = $tdataenrollment_count_by_unit_and_batch[".pagesByType"];
$tdataenrollment_count_by_unit_and_batch[".pages"] = types2pages( my_json_decode( "{\"export\":[\"export\"],\"list\":[\"list\"],\"print\":[\"print\"],\"search\":[\"search\"]}" ) );
$tdataenrollment_count_by_unit_and_batch[".originalPages"] = $tdataenrollment_count_by_unit_and_batch[".pages"];
$tdataenrollment_count_by_unit_and_batch[".defaultPages"] = my_json_decode( "{\"export\":\"export\",\"list\":\"list\",\"print\":\"print\",\"search\":\"search\"}" );
...
$tdataenrollment_count_by_unit_and_batch[".badgeColor"] = "1E90FF";
...
$tdataenrollment_count_by_unit_and_batch[".hasEvents"] = false;
