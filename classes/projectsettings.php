...
class ProjectSettings
{
	...
	*/
	...
	function getConnId()
	{
		...
		if( $connId == "" ) {
			return "financialslatestDbatlocalhost";
		}
		return $connId;
	}
	...
	*/
	...
	public static function getForLogin()
	{
		return !!Security::dbProvider()
			? new ProjectSettings("public.ovcaa_rapid_users", PAGE_LIST)
			: null;
	}
...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "public.ovcaa_rapid_users" ] = array( "url" => "ovcaa_rapid_users", "type" => 0 );
