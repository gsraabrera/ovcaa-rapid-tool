	...
	*/
	...
	protected static function _fillTablesList( $conn )
	{
		...
		if( "financialslatestDbatlocalhost" == $conn->connId )
		{
			...
			$dalTables[$conn->connId][] = array("name" => "class_faculty_in_charge", "varname" => "financialslatestDbatlocalhost_public_class_faculty_in_charge", "altvarname" => "class_faculty_in_charge", "connId" => "financialslatestDbatlocalhost", "schema" => "public", "connName" => "financialslatestDb at localhos");
			...
			$dalTables[$conn->connId][] = array("name" => "courses", "varname" => "financialslatestDbatlocalhost_public_courses", "altvarname" => "courses", "connId" => "financialslatestDbatlocalhost", "schema" => "public", "connName" => "financialslatestDb at localhos");
			$dalTables[$conn->connId][] = array("name" => "faculties", "varname" => "financialslatestDbatlocalhost_public_faculties", "altvarname" => "faculties", "connId" => "financialslatestDbatlocalhost", "schema" => "public", "connName" => "financialslatestDb at localhos");
			$dalTables[$conn->connId][] = array("name" => "ovcaa_rapid_users", "varname" => "financialslatestDbatlocalhost_public_ovcaa_rapid_users", "altvarname" => "ovcaa_rapid_users", "connId" => "financialslatestDbatlocalhost", "schema" => "public", "connName" => "financialslatestDb at localhos");
			$dalTables[$conn->connId][] = array("name" => "s_student_grades", "varname" => "financialslatestDbatlocalhost_public_s_student_grades", "altvarname" => "s_student_grades", "connId" => "financialslatestDbatlocalhost", "schema" => "public", "connName" => "financialslatestDb at localhos");
			...
			$dalTables[$conn->connId][] = array("name" => "student_program_history_view", "varname" => "financialslatestDbatlocalhost_public_student_program_history_view", "altvarname" => "student_program_history_view", "connId" => "financialslatestDbatlocalhost", "schema" => "public", "connName" => "financialslatestDb at localhos");
			$dalTables[$conn->connId][] = array("name" => "student_program_records", "varname" => "financialslatestDbatlocalhost_public_student_program_records", "altvarname" => "student_program_records", "connId" => "financialslatestDbatlocalhost", "schema" => "public", "connName" => "financialslatestDb at localhos");
			$dalTables[$conn->connId][] = array("name" => "student_terms", "varname" => "financialslatestDbatlocalhost_public_student_terms", "altvarname" => "student_terms", "connId" => "financialslatestDbatlocalhost", "schema" => "public", "connName" => "financialslatestDb at localhos");
			$dalTables[$conn->connId][] = array("name" => "students", "varname" => "financialslatestDbatlocalhost_public_students", "altvarname" => "students", "connId" => "financialslatestDbatlocalhost", "schema" => "public", "connName" => "financialslatestDb at localhos");
			$dalTables[$conn->connId][] = array("name" => "users", "varname" => "financialslatestDbatlocalhost_public_users", "altvarname" => "users", "connId" => "financialslatestDbatlocalhost", "schema" => "public", "connName" => "financialslatestDb at localhos");
		}
	}
