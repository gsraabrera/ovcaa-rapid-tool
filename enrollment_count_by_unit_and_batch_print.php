...
require_once("include/enrollment_count_by_unit_and_batch_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "enrollment_count_by_unit_and_batch" );
